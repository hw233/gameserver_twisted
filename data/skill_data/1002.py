...
data = {
    ...
    'hit_1': {
        'type': 'att',
        'damage': {
            'percentage': 0.5,  # 攻击百分比
            'add': 0,  # 攻击附加
            'sector': [240, 360],  # 有此项表示扇形区域攻击，参数1:扇形半径, 参数2:扇形角度
        },
    ...
    'hit_3': {
        ...
        'damage': {
            ...
            'add': 0,  # 攻击附加
            'sector': [250, 360],  # 有此项表示扇形区域攻击，参数1:扇形半径, 参数2:扇形角度
        },
    ...
    'hit_11': {
        ...
        'damage': {
            ...
            'add': 0,  # 攻击附加
            'sector': [220, 120],  # 有此项表示扇形区域攻击，参数1:扇形半径, 参数2:扇形角度
        },
        'move': [-800, 1],
    ...
    'hit_13': {
        ...
        'damage': {
            ...
            'add': 0,  # 攻击附加
            'sector': [240, 180],  # 有此项表示扇形区域攻击，参数1:扇形半径, 参数2:扇形角度
        },
        "sfx": [["/fx/other/hited_heavy.sfx", 5.0, 'hit']],
        'face': True,
        'quake': [0.6, 4, 2],
